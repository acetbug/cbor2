...
export class SYMS {
  /**
   * A 0xFF byte has been found in the stream.  Used as a sentinel.
   */
  public static readonly BREAK = Symbol.for('cbor2/break');

  /**
   * Original CBOR encoding for round-tripping and crypto.
   */
  public static readonly ENCODED = Symbol.for('cbor2/cbor-encoded');

  /**
   * Pre-encoded version of length for arrays and maps.  Must include the
   * major type.
   */
  public static readonly LENGTH = Symbol.for('cbor2/length');
}
