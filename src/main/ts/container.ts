import { DCBOR_INT, MT, NUMBYTES } from './constants';
import {
  type DecodeOptions,
  DiagnosticSizes,
  type MtAiValue,
...
import { type KeyValueEncoded, sortCoreDeterministic } from './sorts';
import { box, getEncoded, saveEncoded } from './box';
import { defaultEncodeOptions, encode } from './encoder';
import { stringToHex, u8concat, u8toHex } from './utils';
import { DecodeStream } from './decodeStream';
import { Simple } from './simple';
import { Tag } from './tag';
import { checkSubnormal } from './float';
...
export class CBORContainer {
   ...
   * whether it wants to ensure that inputs were not encoded incompetently
  ...
  public static decodeToEncodeOpts(
    ...
    return {
      ...
      flushToZero: decode.rejectSubnormal,
  ...
  /**
   * Converts the children to the most appropriate form known.
   *
