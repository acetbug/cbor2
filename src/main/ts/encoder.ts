...
import type {
  EncodeOptions, RequiredEncodeOptions, TagNumber,
} from './options.js';
 ...
 * Deterministic Encoding Profile}).  Enable this set of options by setting
 * `cde` to true.
 *
 ...
 * major type SIMPLE_FLOAT before big-endian bytes.
 *
 ...
 * by default, so it must be explicitly disabled.
 *
 * @example
...
export function encodedNumber(value: bigint | number, encoding: 'i0' | 'i8' | 'i16' | 'i32',
